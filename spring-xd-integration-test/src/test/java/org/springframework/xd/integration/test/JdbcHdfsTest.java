...
public class JdbcHdfsTest extends AbstractIntegrationTest {
	...
	public void initialize() {
		...
		cleanup();
		if (hadoopUtil.test(JdbcHdfsJob.DEFAULT_DIRECTORY)) {
			hadoopUtil.rmr(JdbcHdfsJob.DEFAULT_DIRECTORY);
		}
	}


	/**
	 * Verifies that jdbcHdfsJob has written the test data from a jdbc source table to a hdfs file system.
	 *
	 */
	@Test
