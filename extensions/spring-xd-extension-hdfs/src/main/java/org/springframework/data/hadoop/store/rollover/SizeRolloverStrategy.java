 ...
 * 
 */
public class SizeRolloverStrategy extends AbstractRolloverStrategy implements RolloverSizeAware {
	...
	public boolean hasRolled() {
		if (log.isDebugEnabled()) {
			log.debug("Checking rolloverSize=" + rolloverSize + " against currentSize=" + currentSize);
		}
		return rolloverSize <= currentSize;
	}
