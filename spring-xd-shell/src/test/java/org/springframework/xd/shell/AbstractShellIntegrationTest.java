...
public abstract class AbstractShellIntegrationTest {
	...
	/**
	 * Check if the counter exists. This method is temporary to verify if the counter is created when it received
	 * message.
	...
	protected void checkIfCounterExists(String counterName) {
		...
		assertTrue("Failure. Counter '" + counterName + "' doesn't exist",
	...
	protected void checkCounterValue(String counterName, String expectedCount) {
		CommandResult cr = executeCommand("counter display --name " + counterName);
	...
	protected void deleteCounter(String counterName) {
		CommandResult cr = executeCommand("counter delete --name " + counterName);
