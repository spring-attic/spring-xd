...
public abstract class AbstractIntegrationTest {
	...
	public URL getContainerUrlForSink(String streamName) {
		...
		try {
			result = new URL("http://"
					+ getContainerHostForModulePrefix(streamName, ModuleType.sink) + ":" + DEFAULT_XD_PORT);
		}
	...
	public URL getContainerUrlForProcessor(String streamName) {
		...
		try {
			result = new URL("http://"
					+ getContainerHostForModulePrefix(streamName, ModuleType.processor) + ":" + DEFAULT_XD_PORT);
		}
		catch (MalformedURLException e) {
			throw new IllegalStateException(e.getMessage(), e);
		}
