 ...
 *
 */
public interface FieldValueCounterRepository extends Repository<FieldValueCounter, String> {
	 ...
	 */
	FieldValueCounter save(FieldValueCounter fieldValueCounter);

	/**
	 * Deletes the FieldValueCounter with the given name
	...
	/**
	 * Deletes a given FieldValueCounter
	 * @param counter
	...
	/**
	 * Removes a FieldValueCounter by name
	 * @param name must not null
	 * @return the FieldValueCounter with the given name or null if none found
	...
	/**
	 * Returns all FieldValueCounter instances
	 * @return all FieldValueCounters
	 */
	List<FieldValueCounter> findAll();
