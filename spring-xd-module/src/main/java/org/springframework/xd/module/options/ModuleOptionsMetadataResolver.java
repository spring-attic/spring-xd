...
/**
 * Implementations are able to derive {@link ModuleOptionsMetadata} for a given module.
 * 
 * Note that basic metadata derived from a module may be enriched by collaborators.
 * 
 * @author Eric Bottard
 */
