...
public class ContentTypeTests {
	...
	public void testGetAcceptedMediaTypes() {
		...
		}).when(bus).registerConsumer(anyString(), any(MessageChannel.class), any(Collection.class),
				anyBoolean());
		streamPlugin.postProcessModule(module);
		verify(bus).registerConsumer(anyString(), any(MessageChannel.class), any(Collection.class), anyBoolean());
	}
