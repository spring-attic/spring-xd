 ...
 * Good use case is a list of listeners where user may want to place some of them to be processed before the others.
 * 
...
public class OrderedComposite<S> {
	...
	/**
	 * Public getter for the list of items. The {@link Ordered} items come first, followed by any unordered ones.
	 * 
	...
	/**
	 * Public getter for the list of items in reverse. The {@link Ordered} items come last, after any unordered ones.
	 * 
	 * @return an iterator over the list of items
	 */
