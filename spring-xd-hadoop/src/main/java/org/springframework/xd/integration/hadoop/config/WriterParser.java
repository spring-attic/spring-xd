...
/**
 * Parser for the 'writer' element.
 * 
 * @author Janne Valkealahti
 * 
 */
public class WriterParser extends AbstractBeanDefinitionParser {
	...
	protected String resolveId(Element element, AbstractBeanDefinition definition, ParserContext parserContext)
		...
		if (!StringUtils.hasText(name)) {
			name = IntegrationHadoopSystemConstants.DEFAULT_ID_STORAGE_WRITER;
		}
		return name;
	}
