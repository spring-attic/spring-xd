...
=== Download Spring XD
To download the current GA release, you can download the distribution http://repo.spring.io/libs-release/org/springframework/xd/spring-xd/1.1.2.RELEASE/spring-xd-1.1.2.RELEASE-dist.zip[*spring-xd-1.1.2.RELEASE-dist.zip*] and http://repo.spring.io/libs-release/org/springframework/xd/spring-xd/1.1.2.RELEASE/spring-xd-1.1.2.RELEASE-docs.zip[its accompanying documentation]. 
