...
public class DeploymentConfiguration {
	...
	@Bean
	public ZKStreamDeployer zkStreamDeployer() {
		return  new ZKStreamDeployer(zkConnection, streamDefinitionRepository, streamRepository,
	...
	@Bean
	public ZKJobDeployer zkJobDeployer() {
		return  new ZKJobDeployer(zkConnection, jobDefinitionRepository, jobRepository,
