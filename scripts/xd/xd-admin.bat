...
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% -Dxd.home=%XD_HOME% -Dxd.store=memory -Dlog4j.configuration=file:///%XD_HOME%/config/xd-admin-logger.properties -classpath "%CLASSPATH%" org.springframework.xd.dirt.server.AdminMain %CMD_LINE_ARGS%
