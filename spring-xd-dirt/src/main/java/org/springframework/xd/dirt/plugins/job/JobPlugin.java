...
public class JobPlugin extends AbstractPlugin {
	...
	public void postProcessModule(Module module) {
		...
		if (bus != null) {
			...
			if (inputChannel != null) {
				bus.registerConsumer(JOB_CHANNEL_PREFIX + md.getGroup(), inputChannel,
			...
			if (notificationsChannel != null) {
				bus.registerProducer(md.getGroup() + NOTIFICATION_CHANNEL_SUFFIX, notificationsChannel, true);
			}
		}
	}
	...
	public void removeModule(Module module) {
		MessageBus bus = findMessageBus(module);
		if (bus != null) {
			bus.unregisterConsumers(JOB_CHANNEL_PREFIX + module.getDeploymentMetadata().getGroup());
			bus.unregisterProducers(module.getDeploymentMetadata().getGroup() + NOTIFICATION_CHANNEL_SUFFIX);
		}
	}
