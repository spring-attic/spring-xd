...
public class TupleBuilder {
	...
	public TupleBuilder setNumberFormatFromLocale(Locale locale) {
		...
		formattingConversionService.addConverterFactory(new LocaleAwareStringToNumberConverterFactory(NumberFormat.getInstance(locale)));
		return this;
	}
	...
	protected Tuple newTuple(List<String> names, List<Object> values) {		
		return new DefaultTuple(names, values, formattingConversionService);
	}
