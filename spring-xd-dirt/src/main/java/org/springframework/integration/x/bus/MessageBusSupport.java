...
public abstract class MessageBusSupport implements MessageBus, BeanClassLoaderAware {
	...
	@Override
	public void unregisterConsumers(String name) {
		deleteBridges("inbound." + name);
	}

	@Override
	public void unregisterProducers(String name) {
		deleteBridges("outbound." + name);
	}

	@Override
	public void unregisterConsumer(String name, MessageChannel channel) {
		deleteBridge("inbound." + name, channel);
	}

	@Override
	public void unregisterProducer(String name, MessageChannel channel) {
