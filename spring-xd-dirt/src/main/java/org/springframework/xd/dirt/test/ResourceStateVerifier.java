...
/**
 * Verifies the state of resources (job or stream) by polling repository state until the resource is in the expected state or the operation times out. For use with SingleNodeApplication testing.
...
public class ResourceStateVerifier {
	 ...
	 * @return the deployment status, either State.deployed or the current State when this operation timed out.
	 */
