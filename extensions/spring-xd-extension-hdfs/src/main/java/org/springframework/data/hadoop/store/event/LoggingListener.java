...
/**
 * Simple {@link ApplicationListener} which logs all events based on {@link AbstractStorageEvent} using a log level set
 * during the construction.
 * 
 * @author Janne Valkealahti
 * 
 */
public class LoggingListener implements ApplicationListener<AbstractStorageEvent> {
