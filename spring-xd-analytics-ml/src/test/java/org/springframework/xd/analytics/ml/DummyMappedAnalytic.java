 ...
 */
public class DummyMappedAnalytic extends MappedAnalytic<Tuple,Tuple,Map<String,String>,Map<String,String>, DummyMappedAnalytic> {
     ...
     */
    public DummyMappedAnalytic(InputMapper<Tuple, DummyMappedAnalytic, Map<String, String>> inputMapper, OutputMapper<Tuple, Tuple, DummyMappedAnalytic, Map<String, String>> outputMapper) {
