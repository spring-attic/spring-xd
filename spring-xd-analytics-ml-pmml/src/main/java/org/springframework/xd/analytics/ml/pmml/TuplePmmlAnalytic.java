...
/**
 * A {@link org.springframework.xd.analytics.ml.pmml.PmmlAnalytic} that works with {@link org.springframework.xd.tuple.Tuple}s.
 *
...
public class TuplePmmlAnalytic extends PmmlAnalytic<Tuple,Tuple> {
	 ...
	 */
	public TuplePmmlAnalytic(String name, PmmlResolver pmmlResolver, InputMapper<Tuple, PmmlAnalytic<Tuple,Tuple>, Map<FieldName, Object>> inputMapper, OutputMapper<Tuple, Tuple, PmmlAnalytic<Tuple,Tuple>, Map<FieldName, Object>> outputMapper) {
		super(name, pmmlResolver, inputMapper, outputMapper);
	}

	/**
	 * Creates a new {@link org.springframework.xd.analytics.ml.pmml.TuplePmmlAnalytic}.
	 * Convenience constructor that takes comma-separated {@link String}s as fieldname mappings.
	 *
	 ...
	 */
	public TuplePmmlAnalytic(String name, PmmlResolver pmmlResolver, String inputFieldMappings, String outputFieldMappings){
		this(name, pmmlResolver, new TuplePmmlAnalyticInputMapper(splitFieldMappings(inputFieldMappings)), new TuplePmmlAnalyticOutputMapper(splitFieldMappings(outputFieldMappings)));
	}

	/**
	 * Splits the field mappings of the form {@literal inputField1:outputField1,inputField1:outputField1} into a {@link java.util.List}.
	 *
	 * @param fieldMappings
	 * @return a {@link java.util.List} containing the field mappings as elements or an empty {@code List} if {@code fieldMappings} were {@literal null}.
	 */
