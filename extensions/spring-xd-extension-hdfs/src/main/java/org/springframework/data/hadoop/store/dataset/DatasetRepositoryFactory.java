...
/**
 * Factory class responsible for creating {@link DatasetRepository} instances. Primarily used in configuration
 * code or application contexts.
 */
public class DatasetRepositoryFactory implements InitializingBean {
	...
	/**
	 * The base path for the datasets in this repository. This combined with
	 * the Hadoop configuration 'fs.defaultNS' setting determines the actual full
	 * path used.
	 *
